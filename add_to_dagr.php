...
EOBODY;
    ...
    $dagrName;
   if(isset($_POST['addToDagr'])){
     $dagrName = $_POST['dagrName'];
   }else{
   ...
   if(isset($pid) and isset($_POST["childGuid"])){
       $db_connection->query("INSERT INTO parentchild (pid,cid) VALUES('{$pid}','{$_POST['childGuid']}');");
       $db_connection->query("INSERT INTO childtype (cid,type) VALUES('{$_POST['childGuid']}','{$_POST['childType']}');");
